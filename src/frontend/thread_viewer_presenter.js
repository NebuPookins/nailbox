...
function formatFilesize(size, filesizeLib = globalThis.filesize) {
...
export function renderDeletedMessagesNotice(payload) {
...
export function renderThreadMessage(message, options = {}) {
